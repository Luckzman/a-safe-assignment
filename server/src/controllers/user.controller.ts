...
export class UserController {
  ...
  async getUsers(req: Request, res: Response) {
    ...
    const orderBy: any = {};
    if (sortBy) {
      orderBy[sortBy] = sortOrder === 'asc' ? 'asc' : 'desc'; // Default to descending if not specified
    } else {
      orderBy.createdAt = 'desc'; // Default sorting by createdAt if no sortBy is provided
    }
